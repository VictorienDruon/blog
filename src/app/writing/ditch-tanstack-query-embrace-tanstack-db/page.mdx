...
<ArticleJsonLd
  title="Ditch TanStack Query, Embrace TanStack DB"
  description="How TanStack DB builds on TanStack Query to give you cross-collection queries, sub-millisecond reactivity and optimistic mutations that just work."
/>
