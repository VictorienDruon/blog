...
export const metadata = {
  ...
  description:
    "A practical guide to structuring monorepos with pnpm workspaces: folder structure, shared configs, workspace dependencies and scripts.",
  openGraph: {
    type: "article",
  },
};
...
<ArticleJsonLd
  title="pnpm Workspaces"
  description="A practical guide to structuring monorepos with pnpm workspaces: folder structure, shared configs, workspace dependencies and scripts."
/>
